...
module.exports = {
        ...
        execute(message, args) {
                        ...
                        const person = file.get("links." + message.author.first().id)
                        if (!person) {
                                        ...
                                        if (!userrr) {
                                                ...
                                                if (!product) {
                                                        ...
                                                        axios.get("https://users.roblox.com/v1/users/" + person.roblox)
                                                                .then(function (callback2) {
                                                                        const finalembed = new Discord.MessageEmbed()
                                                                                .setColor(process.env.EMBEDCOLOR)
                                                                                .setAuthor("Booked", message.client.user.avatarURL())
                                                        ...
                                                        const embed = new Discord.MessageEmbed()
                                                                .setColor(process.env.EMBEDCOLOR)
                                                                .setAuthor("You have been booked for our next flight succesfuly!", message.client.user.avatarURL())
